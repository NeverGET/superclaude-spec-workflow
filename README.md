...
|--------|---------|----------------|
| sequential-thinking | Complex problem decomposition | No |
| serena | Session persistence | No |
| context7 | Library documentation | No |
| tavily | Web research | Yes (`TAVILY_API_KEY`) |
| playwright | Browser automation | No |
| chrome-devtools | Performance analysis | No |
| gemini-wrapper | Gemini delegation | No (Gemini CLI auth) |
| filesystem-morph | Fast file editing | No |
| morph | Semantic code merging | No |
...
| [SuperClaude Framework](https://github.com/NickHaecker/SuperClaude) | NickHaecker | Agent architecture, behavioral modes, PM validation patterns |
| [SuperGemini Framework](https://github.com/ruvnet/supergemini) | ruvnet | Gemini CLI integration patterns, delegation strategies |
